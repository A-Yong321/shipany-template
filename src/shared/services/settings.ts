...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      name: 'aistudio',
      title: 'AI Studio',
      description: `Custom <a href="https://openapi.ai-studio.me" class="text-primary" target="_blank">AI Studio</a> settings`,
      tab: 'ai',
    },
    {
      name: 'adsense',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      title: 'AI Studio API Key',
      type: 'password',
      placeholder: 'sk-xxx',
      group: 'aistudio',
      tip: 'AI Studio API Key is used to access the AI Studio API',
      tab: 'ai',
    },
    {
      name: 'aistudio_custom_storage',
      title: 'AI Studio Custom Storage',
      type: 'switch',
      value: 'false',
      group: 'aistudio',
      tab: 'ai',
      tip: 'Use custom storage to save files generated by AI Studio',
    },
    {
      name: 'adsense_code',
      title: 'Adsense Code',
